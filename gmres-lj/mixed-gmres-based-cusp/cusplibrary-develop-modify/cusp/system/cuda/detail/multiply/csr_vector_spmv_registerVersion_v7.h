                       ...
                       BinaryFunction2 reduce)
{
    ...
    for(IndexType row = vector_id; row < num_rows; row += num_vectors)
    {
		...
		ValueType sum4 = 0, sum5 = 0, sum6 = 0, sum7 = 0; 
       ...
       else
       {
		...
		sdata[4][threadIdx.x] = sum4;
		sdata[5][threadIdx.x] = sum5;
		sdata[6][threadIdx.x] = sum6;
		sdata[7][threadIdx.x] = sum7;
